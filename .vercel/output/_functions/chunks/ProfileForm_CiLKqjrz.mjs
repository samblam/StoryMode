import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, f as renderScript, g as createAstro } from './astro/server_CkexDsn7.mjs';
import 'kleur/colors';
import 'clsx';
...
Cancel
</a> </div> <div id="form-status" class="hidden"> <p class="error hidden text-red-600 bg-red-50 p-3 rounded-lg"></p> </div> </form> ${renderScript($$result, "C:/Users/samue/repos/StoryMode/src/components/ProfileForm.astro?astro&type=script&index=0&lang.ts")}`;
