import { c as createComponent, r as renderTemplate, a as addAttribute, b as renderHead, d as renderComponent, e as renderSlot, f as renderScript, g as createAstro, F as Fragment } from './astro/server_CkexDsn7.mjs';
import 'kleur/colors';
/* empty css                         */
...
Logout (${user.email})
</button> ` })}` : renderTemplate`<a href="/login" class="hover:underline">Login</a>`} </div> </nav> </header> <div class="h-20"></div> ${renderSlot($$result, $$slots["default"])} <footer class="bg-indigo-500 text-white py-4"> <div class="max-w-6xl mx-auto px-4 text-center"> <p>&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} Story Mode</p> </div> </footer> ${renderScript($$result, "C:/Users/samue/repos/StoryMode/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
