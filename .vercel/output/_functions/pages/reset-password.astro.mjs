/* empty css                                 */
import { c as createComponent, r as renderTemplate, d as renderComponent, f as renderScript, g as createAstro, m as maybeRenderHead } from '../chunks/astro/server_CkexDsn7.mjs';
import 'kleur/colors';
...
Send Reset Code
</button> <div class="text-center"> <a href="/login" class="text-blue-600 hover:underline">Back to Login</a> </div> </form> </div> </div> </div> </main> ` })} ${renderScript($$result, "C:/Users/samue/repos/StoryMode/src/pages/reset-password/index.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/samue/repos/StoryMode/src/pages/reset-password/index.astro", void 0);

const $$file = "C:/Users/samue/repos/StoryMode/src/pages/reset-password/index.astro";
