import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, f as renderScript, g as createAstro, d as renderComponent } from './astro/server_CkexDsn7.mjs';
import 'kleur/colors';
import 'clsx';
...
</span> </div> ${renderScript($$result, "C:/Users/samue/repos/StoryMode/src/components/VolumeControl.astro?astro&type=script&index=0&lang.ts")}`;
...
Delete
</button>`} </div> </div> ${renderComponent($$result, "AudioProgress", $$AudioProgress, { "soundId": sound.id, "soundFile": sound.file })} </div> </div>`)} </div> ${renderScript($$result, "C:/Users/samue/repos/StoryMode/src/components/SoundList.astro?astro&type=script&index=0&lang.ts")}`;
...
Delete Profile
</button> </div>`} </div> </div> ${profile.sounds.length > 0 ? renderTemplate`${renderComponent($$result, "SoundList", $$SoundList, { "sounds": profile.sounds, "isAdmin": isAdmin })}` : renderTemplate`<p class="text-gray-600 italic">No sounds added to this profile yet.</p>`} </div> ${renderScript($$result, "C:/Users/samue/repos/StoryMode/src/components/ProfileCard.astro?astro&type=script&index=0&lang.ts")}`;
