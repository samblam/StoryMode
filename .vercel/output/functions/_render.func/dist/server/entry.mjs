...
import { c as createExports } from './chunks/entrypoint_CVROQ_MT.mjs';
import { manifest } from './manifest_DUUs_ivc.mjs';
...
const _args = {
    "middlewareSecret": "e8e4cb95-551b-4afe-ac6a-513dbb1ae9cb",
