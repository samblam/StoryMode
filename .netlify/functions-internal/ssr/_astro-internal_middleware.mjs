...
import { A as AstroError, R as ResponseSentError } from './chunks/astro/assets-service_Ceb8GbS5.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
import './chunks/astro/server_Dmwxy-zN.mjs';
...
const onRequest$1 = async ({ request, locals, cookies }, next) => {
  ...
  if (token?.value) {
    try {
      const { supabaseAdmin } = await import('./chunks/supabase_BytQILit.mjs');
