/* empty css                                 */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent } from '../chunks/astro/server_Dmwxy-zN.mjs';
import 'kleur/colors';
import 'html-escaper';
...
Send Message
</button> <div id="form-status" class="hidden p-4 rounded-lg"> <p class="success hidden text-green-600 bg-green-50 p-3 rounded-lg">Thanks for your message! We'll get back to you soon.</p> <p class="error hidden text-red-600 bg-red-50 p-3 rounded-lg"></p> </div> </form> `;
