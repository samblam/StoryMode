/* empty css                                    */
import { c as createComponent, r as renderTemplate, d as renderComponent, b as createAstro, m as maybeRenderHead, a as addAttribute } from '../../chunks/astro/server_Dmwxy-zN.mjs';
import 'kleur/colors';
import 'html-escaper';
...
Reset Password
</button> <div class="text-center"> <a href="/reset-password" class="text-blue-600 hover:underline">Request New Code</a> </div> </form> </div> </div> </div> </main> ` })} `;
